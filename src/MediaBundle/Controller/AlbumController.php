...
class AlbumController extends Controller
{
     ...
     *
     */
    public function showAction(Album $album, Request $request, Commentaire $commentaires)
    {
        ...
        $commentaires = $em->getRepository('MediaBundle:Commentaire')->findBy(array('album'=> $album));
